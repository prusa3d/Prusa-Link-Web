    ...
    <div class="box has-background-black is-paddingless">
      ...
      >
        <g>
          ...
          <path
            d={`M ${
              process.env.PRINTER == "Original Prusa SL1" ? 360 : 410
            }, 285 m -6, 0 a 6, 6 0 1,0 12,0 a 6, 6 0 1,0 -12,0`}
            role="presentation"
            shapeRendering="auto"
          ...
          {process.env.PRINTER == "Original Prusa SL1" && (
            <path
              d="M 416.9515570934256, 285 m -6, 0 a 6, 6 0 1,0 12,0 a 6, 6 0 1,0 -12,0"
              role="presentation"
              shapeRendering="auto"
          ...
          >
            <tspan
              x={process.env.PRINTER == "Original Prusa SL1" ? "368" : "420"}
              dx="0"
              text-anchor="start"
              class="temp-text"
            >
        ...
        <g role="presentation">
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="125.00250008333612"
              x2="125.00250008333612"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="200.00500016667223"
              x2="200.00500016667223"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="275.0075002500083"
              x2="275.0075002500083"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="350.01000033334446"
              x2="350.01000033334446"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="425.01250041668055"
              x2="425.01250041668055"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
          ...
          <g role="presentation">
            <line
              ...
              role="presentation"
              shapeRendering="auto"
              x1="475.01416713890467"
              x2="475.01416713890467"
              y1="250"
              y2="255"
              class="temp-connect-text"
            ></line>
